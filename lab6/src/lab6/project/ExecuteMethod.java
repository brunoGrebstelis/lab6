...
public class ExecuteMethod {
	...
	public void script() throws NoSuchMethodException,
	...
	public void insert(Long id) throws Exception{
		...
		Person p = new Person(newPers.getID(),newPers.getName(),newPers.getCord(),
			newPers.getHeight(),newPers.getPassportID(),newPers.getEyeColor(),newPers.getLocation());
	...
	public void remove(String rem) throws Exception{
		...
		do {
			...
			outStream.writeObject(msg);
			resMsg = (Objects)inStream.readObject();
			if(resMsg.message.equals("1")) {System.out.print("Entered ID does not exist - ");}
	...
	public void remove_greater() throws Exception{
		...
		do {
			...
			outStream.writeObject(msg);
			resMsg = (Objects)inStream.readObject();
			if(resMsg.message.equals("1")) {System.out.print("Entered Key does not exist - ");}
		}while(resMsg.message.equals("1"));
		resMsg = (Objects)inStream.readObject();
		System.out.println(resMsg.message);
	}
